...
1. In the popup for the new resource group, under **Name**, enter **@lab.CloudResourceGroup(ResourceGroup1).Namevm** and then click **OK**.
...
1. On the **Resource groups** blade, locate the @lab.CloudResourceGroup(ResourceGroup1).Namevm resource group.
...
1. On the **@lab.CloudResourceGroup(ResourceGroup1).Namevm** resource group tile, to open the IoT Edge virtual machine, click **vm-az220-training-edge0001-{your-id}**.
