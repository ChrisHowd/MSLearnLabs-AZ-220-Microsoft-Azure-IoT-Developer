...
1. In the **Resource group** dropdown, click **@lab.CloudResourceGroup(ResourceGroup1).Namevm**.
    ...
    > **Note**: One Resource Group is being used for all of the Virtual Machine resources created during this course. If the **@lab.CloudResourceGroup(ResourceGroup1).Namevm** resource group has not already been created, use the following instructions to create it now:
...
1. On the **Resource groups** blade, under **Name**, locate **@lab.CloudResourceGroup(ResourceGroup1).Namevm**.

1. On the right-hand side of the blade, across from **@lab.CloudResourceGroup(ResourceGroup1).Namevm**, click **Click to open context menu** (the ellipsis icon - **...**)
...
1. On the **@lab.CloudResourceGroup(ResourceGroup1).Namevm** resource group tile, to open the Edge Gateway virtual machine, click **vm-az220-training-gw0001-{your-id}**.
...
1. On your **@lab.CloudResourceGroup(ResourceGroup1).Namevm** resource group tile, to open your IoT Edge virtual machine, click **vm-az220-training-gw0001-{your-id}**.
...
1. On the **@lab.CloudResourceGroup(ResourceGroup1).Namevm** resource group tile, click **vm-az220-training-gw0001-{your-id}-nsg**.
