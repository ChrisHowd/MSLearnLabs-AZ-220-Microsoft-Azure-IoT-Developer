...
1. In the **Resource group** textbox, enter **@lab.CloudResourceGroup(ResourceGroup1).Name**
...
1. In the list of named resource groups, click the box to the left of the **@lab.CloudResourceGroup(ResourceGroup1).Name** resource group that your just created.
